...
import type { RecommendationResponse } from '@nasflix/shared';
...
export function RecommendationCarousel({ title, recommendations }: RecommendationCarouselProps) {
  ...
  return (
    <section className="mb-6 md:mb-8">
      <h2 className="text-base md:text-xl font-bold mb-2 md:mb-3 px-3 md:px-8 inline-flex items-center gap-2">
        <span className="bg-primary/15 backdrop-blur-sm border border-primary/30 rounded-xl px-3 md:px-4 py-1 md:py-1.5 flex items-center gap-2">
